...
- (void)bindModel {
    ...
    self.fillModel.startPlace = self.defaultModel;
    [self.headerView.startButton setTitle:self.defaultModel.name forState:UIControlStateNormal];
...
- (void)bindAction{
    ...
    [[self.headerView.startButton rac_signalForControlEvents:UIControlEventTouchUpInside] subscribeNext:^(id x) {
        ...
        vc.completeBlock = ^(CityModel *model) {
            if (![weakSelf.fillModel.endPlace.name isEqualToString:@"唐山"]) {
                [weakSelf.headerView.arriveButton setTitle:weakSelf.defaultModel.name forState:UIControlStateNormal];
                [weakSelf.headerView.arriveButton setTitleColor:APP_COLOR_BLACK_TEXT forState:UIControlStateNormal];
                weakSelf.fillModel.endPlace = weakSelf.defaultModel;
            }
    ...
    [[self.headerView.arriveButton rac_signalForControlEvents:UIControlEventTouchUpInside] subscribeNext:^(id x) {
        ...
        vc.fromNaviC = NO;
        vc.completeBlock = ^(CityModel *model) {
            if (![weakSelf.fillModel.startPlace.name isEqualToString:@"唐山"]) {
                [weakSelf.headerView.startButton setTitle:weakSelf.defaultModel.name forState:UIControlStateNormal];
                [weakSelf.headerView.startButton setTitleColor:APP_COLOR_BLACK_TEXT forState:UIControlStateNormal];
                weakSelf.fillModel.startPlace = weakSelf.defaultModel;
            }
